        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
            ...
            if (mysqli_stmt_fetch($stmt)) {
                if (password_verify($password, $hashed_password)) {
                    ...
                    $_SESSION["usertype"] = $usertype; // Store the user type in session
                    if ($usertype == "driver") {
                        header("location: driver/driver_dashboard.php"); // Redirect driver to driver dashboard
                    } else {
                        header("location: passenger/passenger_dashboard.php"); // Redirect passenger to passenger dashboard
                    }
                } else {
