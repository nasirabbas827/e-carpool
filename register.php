...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($usertype !== "driver" && $usertype !== "passenger") {
        $usertype_err = "Please select a valid user type.";
    }
    ...
    if (empty($username_err) && empty($password_err) && empty($email_err) && empty($phone_err) && empty($age_err) && empty($usertype_err)) {
        ...
        $stmt = mysqli_prepare($conn, $sql);
        mysqli_stmt_bind_param($stmt, "ssssis", $param_username, $param_password, $param_email, $param_phone, $param_age, $param_usertype);
